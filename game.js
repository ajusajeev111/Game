...
function chooseResponse(choice) {
    ...
    setTimeout(() => {
            if (choice === "Who are you ?") {
                ...
                setTimeout(() => {
                    addMessage("kidnapper", "You're here. Now, hand over the money.");
                }, 3000);
                updateOptions([
            ...
            addMessage("kidnapper", "The kidnapper orders the player to drop the ransom and walk away, taking the child with them.");
            updateOptions([
                ...
                const result = Math.random() * 100; 
                        if (Math.floor(result) % 2 === 0) {
                            ...
                            updateOptions([
                            { text: " Mission Success", value: "Mission Success"},
                ...
                updateOptions([
                    ...
                    { text: "Look for another entrance", value: "Look for another entrance" },
                ]);
                ...
                updateNotes("The guards block your way.");
                    const result = Math.random() * 100; 
                        if (Math.floor(result) % 2 === 0) {
                            ...
                            updateOptions([
                            { text: "Untie the child quickly and find an escape route", value: "Escape"},
                            { text: "Attack the kidnapper and try to negotiate", value: "Call friend" }
                        ]);
                        } else {
                ...
                updateOptions([
                    { text: "Continue fighting", value: "Pick the lock" },
                    { text: "Try to escape", value: "Try to escape" },
                ]);
